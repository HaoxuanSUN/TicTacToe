 ...
 *
 * General Board Class
 * An abstract class that have all the common board features/properties 
 * that a game has. 
 * The class ORDEANDCHAOSBOARD and TICTACTOEBOARD inherits from this class.
 */
...
public abstract class GeneralBoard {
	...
	public boolean checkIntegerAviable(int inputCellIndex) {
		...
		if (inputCellIndex < 1 || inputCellIndex > (rowSize * colSize)) {
			System.out.println("This cell is invalid. Please choose a valid cell:");
			return false;
